...
#g=sys.argv[1]
#file.write(g)
file = open("smote_10fold_PSSM-DC_results-new.txt","a+")

filename_train='smote_PSSM-DC-Trainingset-DIV_new.csv'
filename_test='PSSM-DC-Testingset-DIV.csv'
train_data =pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\DC-PSSM\\Normal\\'+filename_train)
test_data = pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\DC-PSSM\\Normal\\'+filename_test)
