...
#g=sys.argv[1]
#file.write(g)
file = open("independent_smote_10fold_Bigram_results-new.txt","a+")

filename_train='smote_PSSM-bigram-Trainingset-new.csv'
filename_test='PSSM-bigram-Testingset.csv'
train_data =pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\bigram\\Normal\\'+filename_train)
test_data = pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\bigram\\Normal\\'+filename_test)
