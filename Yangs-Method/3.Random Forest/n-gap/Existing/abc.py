...
g=sys.argv[1]
#file.write(g)
file = open(g+"smote_val_gap_results.txt","a+")
file.write('\n')
filename_train='smote_'+g+'gapDCTrainingset.csv'
filename_test=g+'gapDCTestingset.csv'
train_data =pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\n-gap\\Existing\\'+filename_train)
test_data = pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\n-gap\\Existing\\'+filename_test)
