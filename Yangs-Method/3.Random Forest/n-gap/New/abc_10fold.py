...
g=sys.argv[1]
file = open(g+"_10_fold_smote_val_gap_results-new.txt","a+")
file.write('\n')
filename_train='smote_'+g+'gapDCTrainingset_new.csv'
filename_test=g+'gapDCTestingset_new.csv'
train_data =pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\n-gap\\New\\'+filename_train)
test_data = pd.read_csv('C:\\Users\Avernus\\Desktop\\Thesis\\Random Forest\\n-gap\\New\\'+filename_test)
